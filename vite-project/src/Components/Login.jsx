    ...
    <>
      ...
      {showForm ? (
        ...
        <div className="w-3/4 m-auto mt-40">
          ...
          <p className="text-white text-3xl ml-72 mt-20 ">
      ...
      {showForm && (
        <form
          ...
          className="absolute top-[250px] left-2/4  transform -translate-x-1/2 -translate-y-1/2 w-11/12 md:w-1/3 bg-black bg-opacity-80 p-3 md:p-6 rounded-lg shadow-lg"
        >
          <h1 className="text-center text-red-600 font-bold text-3xl">{newUserForm?'Sign-Up':'Login'}</h1>
          {newUserForm && (
            <input
          ...
          />
          <button className="bg-red-700 w-20 h-10 rounded ml-40 m-2 text-center hover:bg-red-600 text-white font-bold">
          ...
          >
           {newUserForm?"Already have an Account , Login now": "New to Netflix. Click Here to Sign up"}
          </p>
        </form>
      )}
    </>
